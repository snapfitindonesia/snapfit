...
import { isManualPayment, isFlatShipping, MANUAL_BANK, FLAT_SHIPPING_COST } from "@/lib/payment";
...
export default function CheckoutPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 pb-32 sm:px-6 sm:py-12 md:pb-12">
      ...
      <CheckoutView manualPayment={manualPayment} flatShipping={flatShipping} bank={MANUAL_BANK} flatCost={FLAT_SHIPPING_COST} />
    </div>
  );
}
